...
//        s5.favorite(r1).favorite(r2).favorite(r4).favorite(r5);
    ...
    public void to_string() {
        ...
        assertEquals("Hungry student: John.\n" + "Id: 117.\n" + "Favorites: BBB, DominoPizza, EmptyStore, IceCreamStore, PizzaHut.", s1.toString());
        assertEquals("Hungry student: James.\n" + "Id: 7.\n" + "Favorites: IceCreamStore, PizzaHut.", s2.toString());
        assertEquals("Hungry student: Jack.\n" + "Id: 23.\n" + "Favorites: BBB, DominoPizza.", s3.toString());
        assertEquals("Hungry student: Locke.\n" + "Id: 4.\n" + "Favorites: IceCreamStore, PizzaHut.", s4.toString());
        assertEquals("Hungry student: Kate.\n" + "Id: 51.\n" + "Favorites: BBB, DominoPizza, EmptyStore, PizzaHut.", s5.toString());
